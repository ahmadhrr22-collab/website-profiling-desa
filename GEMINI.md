# GEMINI.md — Website Profil Desa Gongseng

> File ini dibaca otomatis oleh Gemini CLI. Baca seluruhnya sebelum mengerjakan task apapun.
> Konten file ini identik dengan CLAUDE.md — hanya nama file yang berbeda per AI agent.
...
├── GEMINI.md                    ← Kamu sedang baca ini
