  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-300 shadow-xl overflow-hidden">
      ...
      {viewMode === 'photo' ? (
        ...
        /* Mode 2: Bagan Flowchart Vektor SOTK Presisi Simetris Perfect 100% */
        <div className="p-4 sm:p-8 bg-amber-50/15 overflow-x-auto">
          <div className="relative w-[1000px] h-[660px] mx-auto bg-white border-4 border-amber-500/90 rounded-2xl shadow-xl p-5 select-none font-sans">
            ...
            {/* SVG OVERLAY CANVAS: KADES -> SEKDES -> KAUR KEUANGAN ALIGNED AT X = 735 */}
            <svg 
            ...
            >
              {/* 1. Garis Horisontal Koordinasi BPD (X=280) ke Kades Axis (X=735) */}
              <line x1="280" y1="102.5" x2="735" y2="102.5" stroke="#111827" strokeWidth="2" strokeDasharray="6 4" />

              {/* 2. Garis Vertikal Lurus Kades (X=735) dari Bottom (Y=135) ke T-Bar 1 (Y=165) */}
              <line x1="735" y1="135" x2="735" y2="165" stroke="#111827" strokeWidth="2.5" />

              {/* 3. T-Bar Horisontal Utama dari Kasi Center (X=237.5) s/d Kades Axis (X=735) */}
              <line x1="237.5" y1="165" x2="735" y2="165" stroke="#111827" strokeWidth="2.5" />

              {/* 4. Drop Line ke Kasi T-Bar (X=237.5, Y=165 s/d Y=185) */}
              <line x1="237.5" y1="165" x2="237.5" y2="185" stroke="#111827" strokeWidth="2.5" />
              {/* Kasi T-Bar Horisontal (Dari Kasi 1 X=87.5 s/d Kasi 3 X=387.5) */}
              <line x1="87.5" y1="185" x2="387.5" y2="185" stroke="#111827" strokeWidth="2.5" />
              {/* Drop Lines ke Kasi 1, 2, 3 (Y=185 s/d Y=210) */}
              ...
              {/* 5. Drop Line ke Sekdes Top Center (X=735, Y=165 s/d Y=210) */}
              <line x1="735" y1="165" x2="735" y2="210" stroke="#111827" strokeWidth="2.5" />

              {/* 6. GARIS LURUS VERTIKAL DARI SEKDES BOTTOM (Y=275) KE KAUR KEUANGAN (Y=330) VIA T-BAR (Y=305) AT X=735 */}
              <line x1="735" y1="275" x2="735" y2="330" stroke="#111827" strokeWidth="2.5" />
              {/* Kaur T-Bar Horisontal Simetris (Dari Kaur 1 X=580 s/d Kaur 3 X=890) */}
              <line x1="580" y1="305" x2="890" y2="305" stroke="#111827" strokeWidth="2.5" />
              {/* Drop Lines ke Kaur 1 & Kaur 3 */}
              ...
              {/* 7. Trunk Vertikal Utama ke Kasun (X=482.5, Y=165 s/d Y=455) */}
              <line x1="482.5" y1="165" x2="482.5" y2="455" stroke="#111827" strokeWidth="2.5" />
              {/* Kasun T-Bar Horisontal (Dari Kasun 1 X=132.5 s/d Kasun 4 X=867.5) */}
              <line x1="132.5" y1="455" x2="867.5" y2="455" stroke="#111827" strokeWidth="2.5" />
              {/* Drop Lines ke Kasun 1, 2, 3, 4 (Y=455 s/d Y=480) */}
            ...
            {/* KEPALA DESA (Left 600px, Top 70px, Width 270px, Height 65px - Center X = 735px) */}
            <div className="absolute left-[600px] top-[70px] w-[270px] h-[65px] border-2 border-black bg-white rounded overflow-hidden shadow-md z-20 flex flex-col justify-between">
            ...
            {/* SEKRETARIS DESA (Left 615px, Top 210px, Width 240px, Height 65px - Center X = 735px) */}
            <div className="absolute left-[615px] top-[210px] w-[240px] h-[65px] border-2 border-black bg-white rounded overflow-hidden shadow-xs z-20 flex flex-col justify-between">
            ...
            {/* ROW 3: KAUR (UNDER SEKDES - ALIGNED AT X = 735 FOR KAUR KEUANGAN) */}
            {/* Kaur 1 (TU & Umum - Center X = 580) */}
            ...
            {/* Kaur 2 (Keuangan - Left 665px, Width 140px - Center X = 735px) */}
            ...
            {/* Kaur 3 (Perencanaan - Center X = 890) */}
            ...
            {/* CAP PENGESAHAN KEPALA DESA (KANAN BAWAH) */}
