...
export function InteractiveMapViewer() {
  ...
  return (
    <div className="space-y-6">
      {/* Top Action Bar: Download HD PNG & Original PDF */}
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 rounded-2xl bg-emerald-50/70 border border-emerald-100 shadow-sm text-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-extrabold text-gray-900 leading-tight">
              Peta Hasil Pemetaan QGIS Desa Gongseng (Vektor Ultra-HD)
            </h4>
            <p className="text-xs text-gray-600">
              Hasil digitalisasi pemetaan spasial dan batas wilayah resmi KKN-T IPB University 2026.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <a
            ...
            download="Peta-QGIS-Desa-Gongseng-HD.png"
          ...
          >
            ...
            <span>Unduh Peta Ultra-HD (PNG 4K)</span>
          </a>
        </div>
      </div>

      {/* Clean High-Res Map Viewer Box */}
      <div
        ref={containerRef}
      ...
      >
        ...
        <div className="w-full overflow-auto max-h-[85vh] min-h-[500px] flex justify-center items-center p-2 sm:p-4 bg-gray-950">
          ...
          >
            {/* Base Ultra-HD QGIS Map Image Extracted from PDF (3368x2380) */}
            <Image
              src="/images/qgis-hd.png"
              alt="Peta Hasil Pemetaan QGIS Desa Gongseng Megaluh Jombang Ultra HD"
              fill
        ...
        <div className="p-4 bg-gray-900/95 border-t border-gray-800 text-xs text-gray-400 flex flex-col sm:flex-row items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <span>Format Vektor Ultra-HD (3368 x 2380px) — Hasil Ekstraksi PDF Asli QGIS</span>
          </div>
          <span className="text-gray-500 font-medium">Gunakan tombol perbesar (+) untuk melihat detail tulisan legendaris & legenda peta.</span>
        </div>
      </div>
    </div>
  )
